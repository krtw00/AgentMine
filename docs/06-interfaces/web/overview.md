...
従来のSHOGUN（tmuxベース）では状態管理がテキストベースで一貫性を保ちにくかった。AgentMineではDBファーストで状態を管理し、UIはDBを参照・更新する。
...
詳細は [ui-reference.md](./ui-reference.md) を参照。
...
- UI参考資料: [ui-reference.md](./ui-reference.md)
- CLI設計: [cli/overview.md](../cli/overview.md)
- データモデル: [data-model.md](../../04-data/data-model.md)
